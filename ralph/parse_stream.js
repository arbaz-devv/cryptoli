  ...
  try {
    ...
    if (data.type === 'stream_event') {
      ...
      if (event?.type === 'content_block_delta') {
        ...
        if (delta?.partial_json !== undefined) toolInputBuffer += delta.partial_json;
      ...
      if (isError) {
        console.log(`${colors.red}   x Error:${colors.reset}`);
      } else {
      ...
      console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log(`${colors.green}Done${colors.reset} in ${timeStr} | Cost: $${cost.toFixed(4)} | Tokens: ${inputTokens.toLocaleString()} in / ${outputTokens.toLocaleString()} out | Tools: ${toolUseCount}`);
    }
  } catch (e) {
