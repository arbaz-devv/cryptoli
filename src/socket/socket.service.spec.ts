...
describe('SocketService', () => {
  ...
  describe('when socketIO is set', () => {
    ...
    it('emitReviewCreated should emit to reviews room', () => {
      ...
      expect(mockIo.to('reviews').emit).toHaveBeenCalledWith('review:created', {
        id: 'r1',
      });
    });
    ...
    it('emitReviewUpdated should emit to reviews room', () => {
      ...
      expect(mockIo.to).toHaveBeenCalledWith('reviews');
      expect(mockIo.to('reviews').emit).toHaveBeenCalledWith('review:updated', {
        id: 'r1',
      });
    });
    ...
    it('emitReviewVoteUpdated should emit vote data', () => {
      ...
      expect(mockIo.to('reviews').emit).toHaveBeenCalledWith(
        'review:vote:updated',
        {
          reviewId: 'r1',
          helpfulCount: 10,
    ...
    it('emitNotificationCreated should emit to user room', () => {
      ...
      expect(mockIo.to('user:u1').emit).toHaveBeenCalledWith(
